	...
	<div id="Container">
		...
		<form id="owoc">
			...
			<label id="owoce">Owoce:</label><br>
				<input type="checkbox" id="owoce1">jabłko<br>
		...
		<form id="mieso">
			...
			<label id="mieso">Mięso:</label><br>
				<input type="checkbox" id="mieso1">baranina<br>
				<input type="checkbox" id="mieso2">ryby<br>
				<input type="checkbox" id="mieso3">kurczak<br>
				<input type="checkbox" id="mieso4">wołowina<br>
			</div>
		</form>
		<form id="nab">
			<div id="nabial">
		...
		<form id="inne">
			<div id="inne">
				...
				<input type="checkbox" id="inne4">ryż<br>
			</div>
		</form>
		<form id="wybor">
			<div id="wybor">
				<input type="submit" id="wyszukaj" value="Wyszukaj przepis"/>
				<input type="submit" id="uloz" value="Ułóż dietę"/>
			</div>
		</form>
	</div>
  <footer id="footer">
